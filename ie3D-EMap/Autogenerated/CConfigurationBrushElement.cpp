...
#include "CConfigurationBrushElement.h"
std::string CConfigurationBrushElement::getName(void) const
{
...
ui8 CConfigurationBrushElement::getColorR(void) const
{
...
ui8 CConfigurationBrushElement::getColorG(void) const
{
...
ui8 CConfigurationBrushElement::getColorB(void) const
{
...
ui8 CConfigurationBrushElement::getColorA(void) const
{
...
f32 CConfigurationBrushElement::getWidth(void) const
{
...
f32 CConfigurationBrushElement::getHeight(void) const
{
...
std::shared_ptr<CConfigurationCustomModel> CConfigurationBrushElement::getCustomModelConfiguration(void) const
{
...
void CConfigurationBrushElement::serialize(pugi::xml_document& document, const std::string& path)
{
...
void CConfigurationBrushElement::serialize(pugi::xml_document& document, pugi::xpath_node& node)
{
std::string name = node.node().attribute("name").as_string();
IConfiguration::setAttribute("/brush_element/name", std::make_shared<CConfigurationAttribute>(name));
ui8 color_r = node.node().attribute("color_r").as_uint();
