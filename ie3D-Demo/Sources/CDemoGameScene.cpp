...
void CDemoGameScene::update(f32 deltatime)
{
       ...
       material->getShader() != nullptr)
    {
        ...
        static glm::vec2 randomTable[12] = {
            ...
            glm::vec2 ( -0.203345,  0.620716 ),
            glm::vec2 (  0.962340, -0.194983 ),
            glm::vec2 (  0.473434, -0.480026 ),
            glm::vec2 (  0.519456,  0.767022 ),
            glm::vec2 (  0.185461, -0.893124 ),
            glm::vec2 (  0.507431,  0.064425 ),
