...
void ICharacterController::update(f32 deltatime)
{
    ...
    m_camera->setLookAt(glm::vec3(m_position.x, m_position.y + glm::mix(7.5, 5.0, m_speed), m_position.z));
    ...
    {
        m_cameraPrecomputedDistance.y = m_landscape->getHeight(cameraPosition) + 25.0f;
    }
