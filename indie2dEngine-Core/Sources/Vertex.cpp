...
const irr::core::vector3df& Vertex::getPosition() const {
	return position;
}
...
const irr::core::vector3df& Vertex::getNormal() const {
	return normal;
}

const irr::video::SColor& Vertex::getColor() const {
	return color;
}
...
const irr::core::vector2df& Vertex::getTextureCoordinates() const {
...
const irr::core::array<Triangle*>& Vertex::getFaces() const {
	return faces;
}
...
const irr::core::matrix4& Vertex::getQuadric() const {
	return quadric;
}
...
const core::vector2df& Vertex2TCoords::getTextureCoordinates2() const {
...
const core::vector3df& VertexTangets::getTangent() const {
	return tangent;
}

const core::vector3df& VertexTangets::getBinormal() const {
	return binormal;
}
