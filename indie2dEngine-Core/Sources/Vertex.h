...
private:
	...
	irr::core::array<Triangle*> faces; // triangles of which this vertex is part of
...
public:
	 ...
	 */
	Vertex(irr::u32 id, irr::core::vector3df position, irr::core::vector3df normal, irr::video::SColor color = irr::video::SColor(255, 255, 255, 255),
	 ...
	 * @return faces
	 */
	const irr::core::array<Triangle*>& getFaces() const;
...
public:
	 ...
	 */
	Vertex2TCoords(irr::u32 id, irr::core::vector3df position, irr::core::vector3df normal, irr::video::SColor color = irr::video::SColor(255, 255, 255, 255), irr::core::vector2df textureCoordinates =
...
public:
	 ...
	 * @param binormal
	 */
	VertexTangets(irr::u32 id, irr::core::vector3df position, irr::core::vector3df normal, irr::video::SColor color = irr::video::SColor(255, 255, 255, 255), irr::core::vector2df textureCoordinates =
