...
class CComponentSceneUpdate;
typedef std::shared_ptr<CComponentSceneUpdate> CSharedComponentSceneUpdate;
typedef const CSharedComponentSceneUpdate& CSharedComponentSceneUpdateRef;
