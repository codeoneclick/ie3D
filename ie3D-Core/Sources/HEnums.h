...
enum E_GAME_OBJECT_Z_ORDER
{
    ...
    E_GAME_OBJECT_Z_ORDER_ATMOSPHERIC_SCATTERING,
    E_GAME_OBJECT_Z_ORDER_LANDSCAPE,
    E_GAME_OBJECT_Z_ORDER_LANDSCAPE_SEAM,
...
enum E_CONFIGURATION_CLASS
{
    ...
    E_CONFIGURATION_CLASS_ANIMATION,
    E_CONFIGURATION_CLASS_MODEL,
    E_CONFIGURATION_CLASS_SKYBOX,
    E_CONFIGURATION_CLASS_ATMOSPHERIC_SCATTERING,
...
{
    E_SHADER_UNIFORM_MATRIX_M = 0,
    E_SHADER_UNIFORM_MATRIX_V,
    E_SHADER_UNIFORM_MATRIX_P,
    E_SHADER_UNIFORM_MATRIX_N,
    E_SHADER_UNIFORM_MATRIX_VP,
    E_SHADER_UNIFORM_MATRIX_MVP,
...
enum E_CONFIGURATION_ATTRIBUTE_SCALAR
{
    ...
    E_CONFIGURATION_ATTRIBUTE_SCALAR_STRING,
...
enum E_LANDSCAPE_CHUNK_LOD
{
    E_LANDSCAPE_CHUNK_LOD_UNKNOWN = -1,
    E_LANDSCAPE_CHUNK_LOD_01 = 0,
    E_LANDSCAPE_CHUNK_LOD_02,
    E_LANDSCAPE_CHUNK_LOD_03,
    E_LANDSCAPE_CHUNK_LOD_04,
    E_LANDSCAPE_CHUNK_LOD_MAX
};

enum E_LANDSCAPE_SEAM
{
    E_LANDSCAPE_SEAM_X_MINUS = 0,
    E_LANDSCAPE_SEAM_X_PLUS,
    E_LANDSCAPE_SEAM_Z_MINUS,
    E_LANDSCAPE_SEAM_Z_PLUS,
    E_LANDSCAPE_SEAM_MAX
};

enum E_COMPONENT_CLASS
{
    E_COMPONENT_CLASS_UNDEFINED = 0,
    E_COMPONENT_CLASS_TRANSFORMATION,
    E_COMPONENT_CLASS_RENDERING,
    E_COMPONENT_CLASS_DEBUG_RENDERING,
    E_COMPONENT_CLASS_SCENE_UPDATE
};
...
enum E_HEIGHTMAP_GENERATION_STATUS
{
    E_HEIGHTMAP_GENERATION_STATUS_STARTED = 0,
    E_HEIGHTMAP_GENERATION_STATUS_IN_PROGRESS,
    E_HEIGHTMAP_GENERATION_STATUS_ENDED
};
