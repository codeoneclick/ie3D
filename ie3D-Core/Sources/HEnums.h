...
enum E_SHADER_UNIFORM
{
    ...
    E_SHADER_UNIFORM_MATRIX_LIGHT_02_PROJECTION,
    E_SHADER_UNIFORM_MATRIX_LIGHT_03_PROJECTION,
    E_SHADER_UNIFORM_MATRIX_LIGHT_04_PROJECTION,
    E_SHADER_UNIFORM_MATRIX_LIGHT_01_VIEW,
    E_SHADER_UNIFORM_MATRIX_LIGHT_02_VIEW,
    E_SHADER_UNIFORM_MATRIX_LIGHT_03_VIEW,
    E_SHADER_UNIFORM_MATRIX_LIGHT_04_VIEW,
